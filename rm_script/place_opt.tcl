...
redirect -file ${REPORTS_DIR}/${REPORT_PREFIX}/set_qor_strategy.pnr {eval ${set_qor_strategy_cmd} -report_only}
...
redirect -file ${REPORTS_DIR}/${REPORT_PREFIX}/set_stage.placement {eval ${set_stage_cmd} -report}
eval ${set_stage_cmd}
