## created by version 2.0 write_timing_context -format icc2 -output ../output/raven_soc_allfiles.v/raven_soc.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 69491CD7 {
