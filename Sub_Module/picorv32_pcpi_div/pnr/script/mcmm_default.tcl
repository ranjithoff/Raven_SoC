...
create_scenario -name picorv32_pcpi_div -mode default -corner default
report_scenarios
set_scenario_status picorv32_pcpi_div -active true -setup true -hold true -max_transition true \
