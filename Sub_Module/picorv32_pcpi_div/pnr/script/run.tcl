##############################################################################################################
# Internship Raven_SoC (Sub Block - PICORV32_PCPI_DIV)
# Script: run.tcl
##############################################################################################################
...
create_lib -technology $TECH_FILE -ref_libs $REFERENCE_LIBRARY picorv32_pcpi_div
read_verilog ../../synthesis/output/picorv32_pcpi_div_Netlist.v
current_design
...
report_lib -parasitic_tech picorv32_pcpi_div
...
get_ports *clk*
source -echo ../../synthesis/output/picorv32_pcpi_div.sdc
report_clock
...
save_block -as picorv32_pcpi_div/1_initial_design_done
...
source ../script/picorv32_pcpi_div_pns.tcl

check_pg_connectivity
check_pg_drc
check_pg_missing_vias

save_block -as picorv32_pcpi_div/2_power_network_synthesis_done
...
save_block -as picorv32_pcpi_div/3_placement_done
...
save_block -as picorv32_pcpi_div/4_cts_done
...
save_block -as picorv32_pcpi_div/5_routing_done
...
save_block -as picorv32_pcpi_div/6_report_generation_done
...
save_block -as picorv32_pcpi_div/7_filler_cells_done

####################################################
# Convert Netlist to GDSII
####################################################

write_gds ../output/picorv32_pcpi_div.gds

save_block -as picorv32_pcpi_div/8_file_generator_done
