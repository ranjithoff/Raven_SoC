## created by version 2.0 write_timing_context -format icc2 -output ../output/picorv32_pcpi_div_allfiles.v/picorv32_pcpi_div.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 693662C0 {
