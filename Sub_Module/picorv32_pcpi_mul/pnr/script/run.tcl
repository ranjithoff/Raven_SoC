##############################################################################################################
# Internship Raven_SoC (Sub Block - PICORV32_PCPI_MUL)
# Script: run.tcl
##############################################################################################################
...
set ref_libs         "/home1/14_nmts/14_nmts/stdcell_lvt/db_ccs/saed14lvt_ss0p6v125c.db \
                      /home1/14_nmts/14_nmts/stdcell_rvt/db_ccs/saed14rvt_ss0p6v125c.db"
...
create_lib -technology $TECH_FILE -ref_libs $REFERENCE_LIBRARY picorv32_pcpi_mul
read_verilog ../../synthesis/output/picorv32_pcpi_mul_Netlist.v
current_design
...
report_lib -parasitic_tech picorv32_pcpi_mul
...
reset_upf
load_upf ../script/picorv32_pcpi_mul.upf 
commit_upf
...
get_ports *clk*
source -echo ../../synthesis/output/picorv32_pcpi_mul.sdc
report_clock
...
save_block -as picorv32_pcpi_mul/1_initial_design_done
...
initialize_floorplan -core_utilization 0.5 -side_ratio {3 3} -core_offset {5}
shape_blocks
report_design
...
source ../script/picorv32_pcpi_mul_pns.tcl

check_pg_connectivity
check_pg_drc
check_pg_missing_vias

save_block -as picorv32_pcpi_mul/2_power_network_synthesis_done
...
save_block -as picorv32_pcpi_mul/3_placement_done
...
save_block -as picorv32_pcpi_mul/4_cts_done
...
save_block -as picorv32_pcpi_mul/5_routing_done
...
save_block -as picorv32_pcpi_mul/6_report_generation_done
...
save_block -as picorv32_pcpi_mul/7_filler_cells_done

####################################################
# Convert Netlist to GDSII
####################################################

write_gds ../output/picorv32_pcpi_mul.gds

save_block -as picorv32_pcpi_mul/8_file_generator_done
