##############################################################################################################
# Internship Raven_SoC (Sub Block - SPIMEMIO)
# Script: run.tcl
##############################################################################################################
...
create_lib -technology $TECH_FILE -ref_libs $REFERENCE_LIBRARY spimemio
read_verilog ../../synthesis/output/spimemio_Netlist.v
current_design
...
report_lib -parasitic_tech spimemio
...
get_ports *clk*
source -echo ../../synthesis/output/spimemio.sdc
report_clock
...
save_block -as spimemio/1_initial_design_done
...
source ../script/spimemio_pns.tcl

check_pg_connectivity
check_pg_drc
check_pg_missing_vias

save_block -as spimemio/2_power_network_synthesis_done
...
save_block -as spimemio/3_placement_done
...
save_block -as spimemio/4_cts_done
...
save_block -as spimemio/5_routing_done
...
save_block -as spimemio/6_report_generation_done
...
save_block -as spimemio/7_filler_cells_done

####################################################
# Convert Netlist to GDSII
####################################################

write_gds ../output/spimemio.gds

save_block -as spimemio/8_file_generator_done
