## created by version 2.0 write_timing_context -format icc2 -output ../output/simpleuart_allfiles.v/simpleuart.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 691E8D9E {
